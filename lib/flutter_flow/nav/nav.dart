...
class AppStateNotifier extends ChangeNotifier {
  CozmozoneFirebaseUser? initialUser;
  CozmozoneFirebaseUser? user;
  ...
  void update(CozmozoneFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? NavBarPage() : WelcomPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => ProductDetailPageWidget(
                productDetail: params.getParam('productDetail',
            ...
            FFRoute(
              ...
              builder: (context, params) => OrderHistoryPageWidget(),
            ),
            FFRoute(
              name: 'PastOrderDetailPage',
              path: 'pastOrderDetailPage',
              builder: (context, params) => PastOrderDetailPageWidget(
