...
import 'schema/product_order_record.dart';
...
export 'schema/product_order_record.dart';
...
/// Functions to query ProductOrderRecords (as a Stream and as a Future).
Stream<List<ProductOrderRecord>> queryProductOrderRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      ProductOrderRecord.collection(parent),
...
Future<List<ProductOrderRecord>> queryProductOrderRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<ProductOrderRecord>> queryProductOrderRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
